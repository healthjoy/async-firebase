...
def test_build_common_message(fake_async_fcm_client_w_creds, freezer):
...
def test_build_android_message(fake_async_fcm_client_w_creds):
...
def test_build_apns_message(fake_async_fcm_client_w_creds, freezer):
