"""This module houses Async Firebase errors."""
import typing as t
...
class DeadlineExceededError(AsyncFirebaseError):
    ...
    def __init__(self, message, cause=None, http_response=None):
        super().__init__(self, FcmErrorCode.DEADLINE_EXCEEDED.value, message, cause, http_response)
...
class UnavailableError(AsyncFirebaseError):
    ...
    def __init__(self, message, cause=None, http_response=None):
        super().__init__(self, FcmErrorCode.UNAVAILABLE.value, message, cause, http_response)
...
class UnknownError(AsyncFirebaseError):
    ...
    def __init__(self, message, cause=None, http_response=None):
        super().__init__(self, FcmErrorCode.UNKNOWN.value, message, cause, http_response)
...
class UnauthenticatedError(AsyncFirebaseError):
    ...
    def __init__(self, message, cause=None, http_response=None):
        super().__init__(self, FcmErrorCode.UNAUTHENTICATED.value, message, cause, http_response)
...
class ResourceExhaustedError(AsyncFirebaseError):
    ...
    def __init__(self, message, cause=None, http_response=None):
        super().__init__(self, FcmErrorCode.RESOURCE_EXHAUSTED.value, message, cause, http_response)
...
class PermissionDeniedError(AsyncFirebaseError):
    ...
    def __init__(self, message, cause=None, http_response=None):
        super().__init__(self, FcmErrorCode.PERMISSION_DENIED.value, message, cause, http_response)
...
class NotFoundError(AsyncFirebaseError):
    ...
    def __init__(self, message, cause=None, http_response=None):
        super().__init__(self, FcmErrorCode.NOT_FOUND.value, message, cause, http_response)
